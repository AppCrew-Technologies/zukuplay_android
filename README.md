...
Vipul Player is an Android native video player written in Kotlin. It provides a simple and easy-to-use interface for users to play videos on their
Android devices
...
You can help translate Vipul Player on [Hosted Weblate](https://hosted.weblate.org/engage/next-player/).
...
Vipul Player is licensed under the GNU General Public License v3.0. See the [LICENSE](LICENSE) file for more information.

# Vipul Player Admin Panel

Admin panel for Vipul Player app to control ads and broadcasting capabilities.

## Features

- Secure login with fixed admin credentials
- Dashboard with app statistics
- Ads Manager for controlling in-app advertisements
- Broadcasting system to send notifications to users
...
⚠️ **Important**: Change these credentials in production by modifying the constants in `src/utils/AuthContext.js`.
